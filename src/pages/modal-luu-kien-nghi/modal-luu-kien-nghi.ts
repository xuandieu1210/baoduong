...
/**
 * Generated class for the ModalLuuKienNghiPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-modal-luu-kien-nghi',
  templateUrl: 'modal-luu-kien-nghi.html',
})
export class ModalLuuKienNghiPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private view: ViewController,
    ...
    this.kien_nghi_value = this.myData.KIENNGHI;
  ...
  luu_kien_nghi() {
    this.restProvider.do_post_log_out(this.ip + 'congviec/luu', this.modul_chucnang.create_json_luu_kien_nghi_canhan(this.myData.ID_DOTBD.toString(),
      this.myData.ID_THIETBI.toString(), this.myData.NOIDUNG.MA_NOIDUNG, this.myData.ID_NHANVIEN, this.kien_nghi_value), this.token, 1).then((data) => {
        console.log(data)
        if (data['status'] == 1) {
          this.toastCtrl.showToast('middle', 'Lưu thành công!')
          const data1 = {
            trang_thai: "ok",
            kiennghi: this.kien_nghi_value
          };
